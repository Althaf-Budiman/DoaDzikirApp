package com.althaf.doadzikirapp.model
...
object DataDoaDzikir {
    ...
    val listQauliyah: List<DoaDzikirItem>
        get() {
    ...
    private val titleDzkir = arrayOf(
        "Tahlil",
        "Takbir",
        "Tahmid",
        "Tasbih",
    ...
    fun listDzikir(): List<DoaDzikirItem> {
        val dataDzikir = mutableListOf<DoaDzikirItem>()
        for (i in titleDzkir.indices) {
            val data =
                DoaDzikirItem(
                    titleDzkir[i],
                    arabicDzikir[i],
    ...
    private val arabicDikirPagi = arrayOf(
    ...
    fun listDzikirPagi(): List<DoaDzikirItem> {
        ...
        for (i in titleDzikirPagi.indices) {
            val data =
                DoaDzikirItem(
                    titleDzikirPagi[i],
                    arabicDikirPagi[i],
